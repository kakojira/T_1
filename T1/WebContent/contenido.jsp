  ...
  <table width="861" height="596" border="0" bgcolor="#000000">
    ...
    <tr>
      ...
      <td  height="365" colspan="2" bgcolor="#FFFFFF"><table width="635" height="365" border="0" bgcolor="#000000">
        <tr>
          <td width="94" height="25" bgcolor="#FFFFFF"><span class="style2">Unidad 1</span></td>
          <td width="161" rowspan="5" bgcolor="#FFFFFF"><table width="509" height="365" border="0" bgcolor="#FFFFFF">
            <tr>
              <td colspan="2"><span class="style7">Unidad 1: </span></td>
              </tr>
            <tr>
              <td width="50" height="91"><span class="style5">&gt;</span></td>
              <td width="434"><p class="style2">Semana 1: </p>
                <p class="style2"><%=temasInfo.getTema1()%></p></td>
            </tr>
            <tr>
              <td height="111"><span class="style2"><span class="style5">&gt;</span></span></td>
              <td><p class="style2">Semana 2: </p>
                <p class="style2"><%=temasInfo.getTema2()%></p></td>
            </tr>
            ...
            <tr>
              ...
              <td><p>Semana 3:</p>
                <p><span class="style2"><%=temasInfo.getTema3()%></span> </p></td>
              </tr>
        ...
        <tr bgcolor="#CCCCCC">
          <td><span class="style2"><a href="ContenidoServlet?cod=2">Unidad 2</a> </span></td>
          </tr>
        <tr bgcolor="#CCCCCC">
