  ...
  <table width="861" height="596" border="0" bgcolor="#000000">
    ...
    <tr>
      ...
      <td  height="365" colspan="2" bgcolor="#FFFFFF"><table width="635" height="365" border="0" bgcolor="#000000">
        <tr>
          ...
          <td width="161" rowspan="5" bgcolor="#FFFFFF"><table width="509" height="328" border="0" bgcolor="#FFFFFF">
             <tr>
              ...
              <td width="434"><p class="style2">Semana 7: </p>
                <p class="style2"><%=temasInfo.getTema7()%></p></td>
            </tr>
            <tr>
              <td height="111"><span class="style2"><span class="style5">&gt;</span></span></td>
              <td><p class="style2">Semana 8: </p>
                <p class="style2"><%=temasInfo.getTema8()%></p></td>
            </tr>
            ...
            <tr>
              ...
              <td><p>Semana 9:</p>
                <p><span class="style2"><%=temasInfo.getTema9()%></span> </p></td>
              </tr>
        ...
        <tr bgcolor="#CCCCCC">
          <td bgcolor="#FFFFFF"><span class="style2">Unidad 3 </span></td>
          </tr>
        <tr bgcolor="#CCCCCC">
