  ...
  <table width="635" height="596" border="0" bgcolor="#000000">
    ...
    <tr>
      ...
      <td  height="365" colspan="2" bgcolor="#FFFFFF"><table width="509" height="366" border="0" bgcolor="#000000">
        <tr>
          <td width="115" height="43" bgcolor="#FFFFFF"><div align="center" class="style2">Libro 1 </div></td>
          ...
          <td height="317" colspan="5" bgcolor="#FFFFFF"><table width="509" border="0">
            <tr>
              ...
              <td width="360"><table width="500" height="259" border="0">
                <tr>
                  <td height="34"><div align="center" class="style4">Libro1:<%=bibliosInfo.getLibro1()%> </div></td>
                </tr>
                <tr>
            ...
            <tr>
              <td colspan="2"><div align="center" class="style2"><a href="https://www.dropbox.com/sh/a43f5hzkgzd36h0/ZdM-YGRRlT/29110-5-1-2.pdf" target="_blank">ver libro </a></div></td>
              </tr>
          </table></td>
          </tr>
      </table></td>
