    ...
    <tr>
      ...
      <td  height="365" colspan="2" bgcolor="#FFFFFF"><table width="509" height="366" border="0" bgcolor="#000000">
        <tr>
          ...
          <td width="110" bgcolor="#FEFEFE"><div align="center" class="style2">Libro3</div></td>
          <td width="111" bgcolor="#CCCCCC"><div align="center" class="style2"><a href="BibliografiaServlet?cod=4">Libro 4 </a></div></td>
          ...
          <td height="317" colspan="5" bgcolor="#FFFFFF"><table width="509" border="0">
            <tr>
              ...
              <td width="360"><table width="500" height="259" border="0">
                <tr>
                  <td height="34"><div align="center" class="style4">Libro3:<%=bibliosInfo.getLibro3()%> </div></td>
                </tr>
                <tr>
            ...
            <tr>
              <td colspan="2"><div align="center" class="style2"><a href="https://www.dropbox.com/sh/a43f5hzkgzd36h0/403hTePbYf/capitulo%202%20pressman.pdf" target="_blank">ver libro </a></div></td>
              </tr>
          </table></td>
          </tr>
      </table></td>
